  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        success:
          'group-[.toast]:border-secondary-400 group-[.toast]:bg-secondary-50 group-[.toast]:text-secondary-400 dark:group-[.toast]:border-secondary-400 dark:group-[.toast]:bg-secondary-400 dark:group-[.toast]:text-secondary-100',
        error:
          'group-[.toast]:border-red-500 group-[.toast]:bg-red-50 group-[.toast]:text-red-900 dark:group-[.toast]:border-red-600 dark:group-[.toast]:bg-red-950 dark:group-[.toast]:text-red-100',
      }}
      {...props}
    />
  );
