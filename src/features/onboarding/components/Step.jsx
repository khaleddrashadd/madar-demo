...
const Step = ({ title, onSelectFile, onRemoveFile, file }) => {
  ...
  return (
    <div className="w-full px-4 md:px-0 md:w-1/2 mx-auto min-h-[calc(100%-65px)] flex-1 pb-6">
      <div className="flex items-center justify-between py-3 pb-0 md:pt-12">
        <h3 className="text-ivory-900 font-semibold">{title}</h3>
        <Button variant="link" className="text-primary-500 font-semibold">
