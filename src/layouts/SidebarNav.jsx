    ...
    >
      ...
      >
        <div className="flex flex-col gap-10 pt-4">
          ...
          <div className="border-b border-primary-300 pb-4 flex items-center justify-center">
            <Button
              variant="secondary"
              className={cn(
        ...
        <ul className="flex flex-col gap-[10px] py-3 px-2">
          ...
          <SidebarNavExpandableItem
            ...
            routes={[
              {
                title: 'الإبلاغ عن وفاة/عجز كلي',
                to: '/contract-services/report-death',
                className: 'pointer-events-none',
              },
              {
                title: 'إعادة الجدولة',
                to: '/contract-services/reschedule',
                className: 'pointer-events-none',
              },
              {
                title: 'الدفع المبكر',
                to: '/contract-services/early-payment',
                className: 'pointer-events-none',
              },
              {
                title: 'الاحصائيات',
                to: '/contract-services/statistics',
                className: 'pointer-events-none',
              },
            ]}
            baseRoute="/contract-services"
          ...
          <SidebarNavExpandableItem
            ...
            routes={[
              {
                title: 'توثيق عقود المتوفيين',
                to: '/services-verification/deceased-contracts',
                className: 'pointer-events-none',
              },

              {
                title: 'العقود',
                to: '/services-verification/contracts',
                className: 'pointer-events-none',
              },
              {
                title: 'توثيق طلبات إعادة الجدولة',
                to: '/services-verification/reschedule-requests',
                className: 'pointer-events-none',
              },
              {
                title: 'توثيق الدفع المبكر',
                to: '/services-verification/early-payment',
                className: 'pointer-events-none',
              },
              {
                title: 'الاحصائيات',
                to: '/services-verification/statistics',
                className: 'pointer-events-none',
              },
            ]}
            baseRoute="/services-verification"
            handleOpenSidebar={handleOpenSidebar}
          />
          <SidebarNavExpandableItem
            title="علاقات العملاء"
            icon={<ContactRound className="text-white w-6 h-6" />}
            isSidebarOpen={isSidebarOpen}
            routes={[
              {
                title: 'الاحصائيات',
                to: '/relations/statistics',
                className: 'pointer-events-none',
              },
            ]}
            baseRoute="/relations"
            ...
            routes={[
              {
                ...
                to: '/collections/distribution',
                className: 'pointer-events-none',
              },

              {
                title: 'عقود التحصيل',
                to: '/collections/contracts',
                className: 'pointer-events-none',
              },
              {
                title: 'العقود المتعثرة',
                to: '/collections/delinquent-contracts',
              },
            ]}
